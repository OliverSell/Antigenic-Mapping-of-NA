...
author: "Magnus Hilarius Ohline Jepsen and Oliver Sellberg"
date: today
...
file_path_type_legend <- file.path(latest_folder_path, paste0("ac_map_Influenza_", today_date, ".jpg"))
...
file_path_type_labels <- file.path(latest_folder_path, paste0("ac_map_Influenza_", today_date, "_label.jpg"))
...
file_path_group_legend <- file.path(latest_folder_path, paste0("ac_map_Influenza_", today_date, "_grouped.jpg"))
...
file_path_group_labels <- file.path(latest_folder_path, paste0("ac_map_Influenza_", today_date, "_grouped_label.jpg"))
...
file_path_blank <- file.path(latest_folder_path, paste0("ac_map_Influenza_", today_date, "_plain.jpg"))

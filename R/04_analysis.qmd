...
names(cluster_colors) <- as.character(seq_len(num_clusters)) # FIX FIX FIX FIX
# FIX FIX FIX FIX # FIX FIX FIX FIX # FIX FIX FIX FIX # FIX FIX FIX FIX
...
base_map <- ggplot(dd) +
  ...
  #scale_x_continuous(
  #    breaks = function(V1) seq(from = V1[1], to = V1[2], by = 1)
  #  ) +
  #  ggplot2::scale_y_continuous(
  #    breaks = function(V2) seq(from = V2[1], to = V2[2], by = 1)
   # ) +
    # ggplot2::coord_fixed(      expand = FALSE,      xlim = xlim,       ylim = ylim    ) + 
  theme_minimal() +
...
# FIX FIX FIX FIX
dd_cluster <- dd |> # FIX FIX FIX FIX
  filter(type == "AG") |> # FIX FIX FIX FIX
  filter(cluster != 0) # FIX FIX FIX FIX
# FIX FIX FIX FIX

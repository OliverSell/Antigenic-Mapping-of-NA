...
```{r}
list.of.packages <- c("tidyverse", "readxl", "Racmacs", "viridis", "ggrepel", "svglite", "knitr", "dbscan", "ggforce", "RColorBrewer")
...
excel_data <- read_excel("../data/_raw/antigenic_map_template.xlsx")  ## AUTOMATE
## SPØRG MARTHA
## SPØRG MARTHA
## SPØRG MARTHA
...
titer_table <- read_csv(file = "../data/_raw/excel_csv.csv.gz")
